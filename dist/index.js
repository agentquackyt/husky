...
class Husky {
  ...
  use(router) {
    ...
    this.routerList.sort((a, b) => b.getBaseRoute.length - a.getBaseRoute.length);
  }
  start({ port, callback } = {}) {
...
class Router {
  ...
  run(req) {
    ...
    for (let i = 0;i < this.routes.length; i++) {
      ...
      if (endpoint.route.length !== paths.length)
        continue;
      let isCorrect = true;
      let params = {};
  ...
  get(url, callback) {
    ...
    if (isStatic) {
      ...
      this.staticRoutes["GET" /* GET */].set(key, callback);
    } else {
      this.routes.push({ route: segments, callback, method: "GET" /* GET */ });
    }
    return this;
  }
  post(url, callback) {
    ...
    if (isStatic) {
      const key = segments.join("/") || "";
      this.staticRoutes["POST" /* POST */].set(key, callback);
    } else {
      this.routes.push({ route: segments, callback, method: "POST" /* POST */ });
    }
    return this;
  }
  put(url, callback) {
    ...
    if (isStatic) {
      const key = segments.join("/") || "";
      this.staticRoutes["PUT" /* PUT */].set(key, callback);
    } else {
      this.routes.push({ route: segments, callback, method: "PUT" /* PUT */ });
    }
    return this;
  }
  delete(url, callback) {
    ...
    if (isStatic) {
      const key = segments.join("/") || "";
      this.staticRoutes["DELETE" /* DELETE */].set(key, callback);
    } else {
      this.routes.push({ route: segments, callback, method: "DELETE" /* DELETE */ });
    }
    return this;
  }
}
...
var ot = (t, e, r) => (Ya(t, e, "default"), r && Ya(r, e, "default"));
...
var v = P((L) => {
  ...
  function _r(i) {
    var r, t = Q(i), e = t[0], n = t[1], o = new Rr(Cr2(i, e, n)), u = 0, f = n > 0 ? e - 4 : e, c;
    for (c = 0;c < f; c += 4)
...
var b = P((_) => {
  var j = v(), T2 = rr(), tr = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  _.Buffer = h;
  _.SlowBuffer = Pr;
  ...
  function br(i, r, t) {
    return ur2(i), i <= 0 ? m(i) : r !== undefined ? typeof t == "string" ? m(i).fill(r, t) : m(i).fill(r) : m(i);
  }
  h.alloc = function(i, r, t) {
    return br(i, r, t);
  };
  function X(i) {
    return ur2(i), m(i < 0 ? 0 : V(i) | 0);
  }
  ...
  h.prototype.readFloatLE = function(r, t) {
    return r = r >>> 0, t || a(r, 4, this.length), T2.read(this, r, true, 23, 4);
  };
  h.prototype.readFloatBE = function(r, t) {
    return r = r >>> 0, t || a(r, 4, this.length), T2.read(this, r, false, 23, 4);
  };
  h.prototype.readDoubleLE = function(r, t) {
    return r = r >>> 0, t || a(r, 8, this.length), T2.read(this, r, true, 52, 8);
  };
  h.prototype.readDoubleBE = function(r, t) {
    return r = r >>> 0, t || a(r, 8, this.length), T2.read(this, r, false, 52, 8);
  };
  ...
  h.prototype.writeBigUInt64LE = I(function(r, t = 0) {
    return pr2(this, r, t, BigInt(0), BigInt("0xffffffffffffffff"));
  });
  ...
  h.prototype.writeBigInt64LE = I(function(r, t = 0) {
    return pr2(this, r, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
  });
  ...
  h.prototype.writeFloatLE = function(r, t, e) {
    return ar2(this, r, t, true, e);
  };
  h.prototype.writeFloatBE = function(r, t, e) {
    return ar2(this, r, t, false, e);
  };
  ...
  var Qr2 = /[^+/0-9A-Za-z-_]/g;
  function vr(i) {
    if (i = i.split("=")[0], i = i.trim().replace(Qr2, ""), i.length < 2)
      return "";
    for (;i.length % 4 !== 0; )
      i = i + "=";
    return i;
...
var y = {};
Ur(y, { Blob: () => ot2, Buffer: () => Er.Buffer, File: () => ut, atob: () => ht, btoa: () => ft, constants: () => lt, createObjectURL: () => ct, default: () => Br.Buffer, isAscii: () => pt, isUtf8: () => st, kMaxLength: () => nt, kStringMaxLength: () => K, resolveObjectURL: () => at, transcode: () => yt });
w(y, O(b()));
var Br = O(b());
var Er = O(b());
var K = 2 ** 32 - 1;
var nt = 9007199254740991;
var { Blob: ot2, File: ut, atob: ht, btoa: ft } = globalThis;
...
function base64url_encode(data) {
  const buffer = export_Buffer.isBuffer(data) ? data : export_Buffer.from(data, "utf-8");
...
function base64URLdecode(str) {
  ...
  return export_Buffer.from(base64WithPadding, "base64").toString("utf-8");
}
var JWT = {
  settings: {
  ...
  sign: (payloadJson) => {
    const header = base64url_encode(JSON.stringify({ alg: JWT.settings.algorithm, typ: "JWT" }));
    const payload = base64url_encode(JSON.stringify(payloadJson));
    const dataToSign = `${header}.${payload}`;
    const hash = Wq.createHmac("SHA256", JWT.settings.secret).update(dataToSign);
